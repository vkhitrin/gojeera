...
from gojeera.utils.test_utilities import load_json_response
...
@patch('gojeera.api_controller.factories.CONFIGURATION')
...
@patch('gojeera.api_controller.factories._build_related_inward_issue')
@patch('gojeera.api_controller.factories.CONFIGURATION')
...
@patch('gojeera.api_controller.factories._build_related_outward_issue')
@patch('gojeera.api_controller.factories.CONFIGURATION')
