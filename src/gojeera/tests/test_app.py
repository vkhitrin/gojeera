...
from gojeera.models import JiraServerInfo, WorkItemsSearchOrderBy
...
async def test_application_title(
    ...
    async with app.run_test() as pilot:
        assert pilot.app.title == 'gojeera'
...
@patch('gojeera.widgets.screens.APIController.server_info')
@patch('gojeera.widgets.screens.MainScreen.get_users')
@patch('gojeera.widgets.screens.MainScreen.fetch_statuses')
@patch('gojeera.widgets.screens.MainScreen.fetch_issue_types')
@patch('gojeera.widgets.screens.MainScreen.fetch_projects')
...
async def test_application_title_without_custom_title_with_server_info(
    ...
    async with app.run_test() as pilot:
        assert pilot.app.title == 'gojeera - my title'
