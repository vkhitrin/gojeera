...
from gojeera.widgets.attachments.attachments import (
...
@patch('gojeera.widgets.screens.APIController.get_attachment_content')
@patch('gojeera.widgets.screens.APIController.get_issue')
@patch('gojeera.widgets.screens.MainScreen._search_work_items')
@patch('gojeera.widgets.screens.MainScreen.get_users')
@patch('gojeera.widgets.screens.MainScreen.fetch_statuses')
...
@patch('gojeera.widgets.attachments.attachments.build_external_url_for_attachment')
@patch('gojeera.widgets.screens.APIController.get_attachment_content')
@patch('gojeera.widgets.screens.APIController.get_issue')
@patch('gojeera.widgets.screens.MainScreen._search_work_items')
@patch('gojeera.widgets.screens.MainScreen.get_users')
...
@patch('gojeera.widgets.attachments.attachments._image_support_is_enabled')
