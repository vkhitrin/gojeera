...
class HelpScreen(ModalScreen):
    ...
    TITLE = 'gojeera Help'
    HELP = 'This is the in-app help system. If what you are looking for is not here then please refer to the official help at https://gojeera.readthedocs.io/en/latest/index.html'
    ...
    def __init__(self, anchor: str | None = None):
        ...
        try:
            ...
            self._content = 'Unable to load the contents of the help. Please refer to https://gojeera.readthedocs.io/en/latest/index.html'
