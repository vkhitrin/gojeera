...
class LazySelect(VimSelect):
    ...
    def _start_spinner(self) -> None:
        if self._is_loading and self._spinner_timer is not None:
            return
        self._spinner_index = 0
    ...
    def _update_spinner(self) -> None:
        ...
        if new_prompt == self._current_spinner_text:
            return
        self._current_spinner_text = new_prompt
    ...
    def _stop_spinner(self) -> None:
        if self._is_loading:
            ...
            if self._spinner_timer:
                ...
                self._spinner_timer = None
            self._current_spinner_text = self._original_prompt
