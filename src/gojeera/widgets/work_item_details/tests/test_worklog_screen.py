...
from gojeera.models import JiraIssue, JiraIssueSearchResponse, JiraWorklog, PaginatedJiraWorklog
from gojeera.widgets.filters import ProjectSelectionInput
...
@patch.object(IssueDetailsWidget, '_refresh_work_item_details')
@patch('gojeera.widgets.screens.APIController.add_work_item_worklog')
...
@patch('gojeera.widgets.work_item_details.work_log.build_external_url_for_work_log')
@patch('gojeera.widgets.screens.APIController.get_work_item_worklog')
@patch('gojeera.widgets.screens.APIController.get_issue')
@patch('gojeera.widgets.screens.MainScreen._search_work_items')
@patch('gojeera.widgets.screens.MainScreen.get_users')
@patch('gojeera.widgets.screens.MainScreen.fetch_statuses')
...
@patch('gojeera.widgets.screens.APIController.remove_worklog')
@patch('gojeera.widgets.work_item_details.work_log.build_external_url_for_work_log')
@patch('gojeera.widgets.screens.APIController.get_work_item_worklog')
@patch('gojeera.widgets.screens.APIController.get_issue')
@patch('gojeera.widgets.screens.MainScreen._search_work_items')
